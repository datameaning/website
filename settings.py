...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/froloe/website/website.db', # Or path to database file if using sqlite3.
...
SECRET_KEY = 'ck1wxld#f5a^xker5le(g(xpd*1ufc=yy2&4k&(njvd!85=@y='
...
TEMPLATE_DIRS = (
    ...
    templateDir,
    templateDir + "/includes",
    templateDir + "/information",  
)
